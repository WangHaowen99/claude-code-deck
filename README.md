...
v0.2.2 新增：三窗口模式 + 单窗口 provider 选择，通过 claude-use 切换不同 API 供应商和模型，侧边栏一键广播。

直接下载编译好的 VSIX：

[claude-code-deck-0.2.4.vsix](https://github.com/WangHaowen99/claude-code-deck/raw/develop/dist/claude-code-deck-0.2.4.vsix)

下载后安装：

```bash
code --install-extension claude-code-deck-0.2.4.vsix
```
